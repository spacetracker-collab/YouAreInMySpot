...
class _ExampleRouteState extends State<ExampleRoute> {
  final List<CardExample> cards = [
    CardExample(color: Colors.red, text: "Welcome to Discovering your Restaturant Seating Preferences in Space-Time! Swipe up or right if the criteria is important. Left or down if not important. "),
