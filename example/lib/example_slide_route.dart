...
class _ExampleRouteSlideState extends State<ExampleRouteSlide> {
  ...
  final List<CardExample> cards = [
    ...
    CardExample(color: Colors.white, text: "", number:"",imageLocation:"assets/images/swipe-right-left.png"),
    CardExample(color: Colors.green, text: "Romantic", number: "\n \n \n \nSelection:\n1/40",imageLocation:"assets/images/romantic-dinner.png" ),
    CardExample(color: Colors.green, text: "Pandemic Precautions", number: "\n \n \n \nSelection:\n2/40",imageLocation:"assets/images/pandemic.png"),
    CardExample(color: Colors.green, text: "Child Seating", number: "\n \n \n \nSelection:\n3/40",imageLocation:"assets/images/children.png"),
    CardExample(color: Colors.green, text: "No Smoking Zone", number: "\n \n \n \nSelection:\n4/40",imageLocation:"assets/images/no-smoking.png"),
    CardExample(color: Colors.green, text: "Vegetarian", number: "\n \n \n \nSelection:\n5/40",imageLocation:"assets/images/vegan.png"),
    CardExample(color: Colors.green, text: "Far from Rest Room", number: "\n \n \n \nSelection:\n6/40",imageLocation:"assets/images/no-toilet.png"),
    CardExample(color: Colors.green, text: "Family Friendly",number:"\n \n \n \nSelection:\n7/40",imageLocation:"assets/images/family.png"),
    CardExample(color: Colors.green, text: "Good Lighting", number: "\n \n \n \nSelection:\n8/40",imageLocation:"assets/images/lightbulb.png"),
    CardExample(color: Colors.green, text: "Interior Decor", number: "\n \n \n \nSelection:\n9/40",imageLocation:"assets/images/interior.png"),
    CardExample(color: Colors.green, text: "Open Air", number :"\n \n \n \nSelection:\n10/40",imageLocation:"assets/images/window.png"),
    CardExample(color: Colors.green, text: "Privacy", number: "\n \n \n \nSelection:\n11/40",imageLocation:"assets/images/privacy.png"),
    CardExample(color: Colors.green, text: "Heater/Cooler", number: "\n \n \n \nSelection:\n12/40",imageLocation:"assets/images/heater.png"),
    CardExample(color: Colors.green, text: "Low Sound Levels", number: "\n \n \n \nSelection:\n13/40",imageLocation:"assets/images/volume.png"),
    CardExample(color: Colors.green, text: "World View", number: "\n \n \n \nSelection:\n14/40",imageLocation:"assets/images/eye.png"),
    CardExample(color: Colors.green, text: "Business Friendly", number : "\n \n \n \nSelection:\n15/40",imageLocation:"assets/images/team.png"),
    CardExample(color: Colors.green, text: "Party Friendly", number: "\n \n \n \nSelection:\n16/40",imageLocation:"assets/images/party.png"),
    CardExample(color: Colors.green, text: "Senior Friendly", number : "\n \n \n \nSelection:\n17/40",imageLocation:"assets/images/senior.png"),
    CardExample(color: Colors.green, text: "Close to Media", number : "\n \n \n \nSelection:\n18/40",imageLocation:"assets/images/live.png"),
    CardExample(color: Colors.green, text: "Fountain View", number: "\n \n \n \nSelection:\n19/40",imageLocation:"assets/images/fountain.png"),
    CardExample(color: Colors.green, text: "Outdoor Seating", number: "\n \n \n \nSelection:\n20/40",imageLocation:"assets/images/terrace.png"),
    CardExample(color: Colors.green, text: "Accessible Rest Rooms" , number: "\n \n \n \nSelection:\n21/40",imageLocation:"assets/images/toilet.png"),
    CardExample(color: Colors.green, text: "Dancing Area", number:"\n \n \n \nSelection:\n22/40",imageLocation:"assets/images/dance-floor.png"),
    CardExample(color: Colors.green, text: "Smoking Zone" , number: "\n \n \n \nSelection:\n23/40",imageLocation:"assets/images/smoking-area.png"),
    CardExample(color: Colors.green, text: "WiFi Signal", number: "\n \n \n \nSelection:\n24/40",imageLocation:"assets/images/wifi-signal.png"),
    CardExample(color: Colors.green, text: "Charging Point", number: "\n \n \n \nSelection:\n25/40",imageLocation:"assets/images/point.png"),
    CardExample(color: Colors.green, text: "Cleanliest", number: "\n \n \n \nSelection:\n26/40",imageLocation:"assets/images/cleanliness.png"),
    CardExample(color: Colors.green, text: "Specially-abled support", number : "\n \n \n \nSelection:\n27/40",imageLocation:"assets/images/disability.png"),
    CardExample(color: Colors.green, text: "Self Service",number:"\n \n \n \nSelection:\n28/40",imageLocation:"assets/images/self-service.png"),
    CardExample(color: Colors.green, text: "Wireless Payment",number:"\n \n \n \nSelection:\n29/40",imageLocation:"assets/images/credit-card.png"),
    CardExample(color: Colors.green, text: "Non Alcohol ",number:"\n \n \n \nSelection:\n30/40",imageLocation:"assets/images/no-alcohol.png"),
    CardExample(color: Colors.green, text: "Eco Friendly",number:"\n \n \n \nSelection:\n31/40",imageLocation:"assets/images/biodegradable.png"),
    CardExample(color: Colors.green, text: "Parking Spot",number:"\n \n \n \nSelection:\n32/40",imageLocation:"assets/images/signage.png"),
    CardExample(color: Colors.green, text: "Expandable Seating",number:"\n \n \n \nSelection:\n33/40",imageLocation:"assets/images/expand.png"),
    CardExample(color: Colors.green, text: "Pet Allowed",number:"\n \n \n \nSelection:\n34/40",imageLocation:"assets/images/pets-allowed.png"),
    CardExample(color: Colors.green, text: "Breast Feeding Area",number:"\n \n \n \nSelection:\n35/40",imageLocation:"assets/images/breastfeeding.png"),
    CardExample(color: Colors.green, text: "Play Area",number:"\n \n \n \nSelection:\n36/40",imageLocation:"assets/images/theme-park.png"),
    CardExample(color: Colors.green, text: "Secure Spot",number:"\n \n \n \nSelection:\n37/40",imageLocation:"assets/images/shield.png"),
    CardExample(color: Colors.green, text: "Mobile Restaurant",number:"\n \n \n \nSelection:\n38/40",imageLocation:"assets/images/food-truck.png"),
    CardExample(color: Colors.green, text: "Leftover Bag",number:"\n \n \n \nSelection:\n39/40",imageLocation:"assets/images/wheat-sack.png"),
    CardExample(color: Colors.green, text: "Online Booking",number:"\n \n \n \nSelection:\n40/40",imageLocation:"assets/images/booking.png"),
